// 10-1.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
int main()
{
    ...
    pos3.ShowPosition();
    pos4.ShowPosition();
    (pos3 + pos4).ShowPosition();       // 객체를 반환하므로 함수호출 가능
    cout << endl;
    ...
    cout << (pos1 == pos2) << endl;     // 0
    cout << (pos2 == pos2) << endl;     // 1
    cout << (pos1 != pos2) << endl;     // 1
    cout << (pos2 != pos2) << endl;     // 0
    return 0;
}
