// EmployeeManager4.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
public:
    ...
    virtual int GetPay() const { return 0; }        // 가상함수로 선언
    virtual void ShowSalaryInfo() const {}          // 가장 마지막에 오버라이딩을 진행한 함수를 호출하게 함
};
